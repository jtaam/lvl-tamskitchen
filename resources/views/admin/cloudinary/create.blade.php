                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Add Cloudinary Credentials</h4>
                        </div>
                        <div class="card-content">
                            <form method="POST" action="{{ route('cloudinary.store') }}">
                                @csrf
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title ">Add Cloudinary Detail</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="cloud_name" id="cloud_name">
                                                </div>
                                            </div>
